...
import com.niloy.robobaj2.component.StudentColumn

@Composable
fun StudentList(navHostController: NavHostController,viewModel: StudentListViewModel){
    ...
    Column(modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        LazyColumn(contentPadding = PaddingValues(5.dp), modifier = Modifier.fillMaxWidth(.9f)){
            items(students){ student ->
                StudentAttendanceColumn(student = student)
            }
        }
    }
}